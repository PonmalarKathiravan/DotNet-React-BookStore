...
const Orders = (props) => {
    ...
    useEffect(() => {
        axios.get(`https://8080-effddfdaeebcfacbdcbaeaaadcacbbdccadeba.examlyiopb.examly.io/user/${credentials.username}/orders`)
        .then(res => {
            if(res.data) {
    ...
    const clearAll = () => {
        axios.delete(`https://8080-effddfdaeebcfacbdcbaeaaadcacbbdccadeba.examlyiopb.examly.io/user/deleteall`)
        .then(res => {
