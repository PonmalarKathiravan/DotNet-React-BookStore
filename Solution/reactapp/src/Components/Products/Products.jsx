...
const Products = props => {
    ...
    useEffect(() => {
        axios.get("https://8080-effddfdaeebcfacbdcbaeaaadcacbbdccadeba.examlyiopb.examly.io/Product/products")
        .then(res => {
    ...
    const onAddToCart = product => () => {
        ...
        console.log("add Cart 2", cartItem);
        axios.post("https://8080-effddfdaeebcfacbdcbaeaaadcacbbdccadeba.examlyiopb.examly.io/Cart/user/addcart", cartItem)
        .then(res => {
            if(res.data == 'success') {
            ...
            {
                authContent.notify(`Product ${product.productName} not added to cart`, 'warn');
            }
    ...
    const onDeleteProduct = product => {
        axios.delete("https://8080-effddfdaeebcfacbdcbaeaaadcacbbdccadeba.examlyiopb.examly.io/Product/admin/deleteProduct/" + product.productId)
        .then(res => {
            console.log("Product ",);
